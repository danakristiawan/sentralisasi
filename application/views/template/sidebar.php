...
<aside class="main-sidebar sidebar-light-secondary elevation-4">
  ...
  <a href="<?= base_url('home'); ?>" class="brand-link">
    <img src="<?= base_url(); ?>assets/img/bookshelf-128.png" alt="Alika Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">Sentralisasi</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        $row = $this->db->query("SELECT nama FROM ref_pegawai WHERE nip='$nip'")->row_array();
        $nama = $row['nama'];
        ?>
