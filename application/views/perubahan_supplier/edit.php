              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select name="bulan" class="form-control">
                      <?php foreach ($bulan as $s) : ?>
                        <option value="<?= $s['kode']; ?>" <?= $s['kode'] == $supplier['bulan'] ? 'selected' : ''; ?>><?= $s['bulan']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="jumlah" class="form-control <?= form_error('jumlah') ? 'is-invalid' : '' ?>" value="<?= $supplier['jumlah']; ?>">
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="form-group">
                    ...
                    <input type="text" name="ket" class="form-control <?= form_error('ket') ? 'is-invalid' : '' ?>" value="<?= $supplier['ket']; ?>">
                    <div class="invalid-feedback">
                      <?= form_error('ket') ?>
                    </div>
                  </div>
