      ...
      <div class="col">
        <div class="card">
                ...
                <tbody>
                  ...
                  foreach ($pegawai as $r) :
                    ...
                    <tr>
                      ...
                      <td><?= $nama; ?></td>
                      <td>
                        <input class="form-check-input-user" type="checkbox" <?= check_nip($nip); ?> data-nip="<?= $nip; ?>" data-nama="<?= $nama; ?>"> tambah
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
          ...
          <div class="card-footer">
            <a href="<?= base_url('user'); ?>" class="btn btn-sm btn-secondary float-left"><i class="fa fa-undo"></i> Kembali</a>
          </div>
        </div>
      </div>
    </div>
