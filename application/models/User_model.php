...
class User_model extends CI_Model
{
  ...
  {
    return $this->db->query("SELECT a.*, b.name, c.nama AS satker FROM system_user a LEFT JOIN system_role b ON a.role_id=b.id LEFT JOIN ref_eselon3 c ON a.satker_id=c.id")->result_array();
  }
